# -*- coding: utf-8 -*-
"""u-net segmentaion.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1CVZIEzPGAXEo_W0oqmsSM1GNxQNCUQPk
"""
...
def get_segmentation_model():
    ...
    model = tf.keras.models.load_model('C:\Users\research\Desktop\segmentaion')
    return model
...
model_kaggle=get_segmentation_model()
...
img=getImage('../input_c/segmentation/Jun_coronacases_case10_111.png')
y=getImage('../input/covid19-ct-scan-lesion-segmentation-dataset/masks/Jun_coronacases_case10_111.png')
...
ax[1].imshow(np.squeeze(y), cmap='gray')
plt.show()

#oo=(img*pred_th)
#res=cv2.imwrite(''../input_c/segmentation/x.jpg'',oo[0]*255)

x=cv2.imread('../input_c/segmentation/Jun_coronacases_case10_111.png')
#print(x)
plt.imshow(x,cmap='gray')
#np.unique(x),np.unique(oo[0])
